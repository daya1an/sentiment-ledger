...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Invoice> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "ledger-processing-group");
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        props.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class.getName());

        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.daya.project.sentiment_ledger.model.Invoice");
